...
<div class="container">
    ...
    <div class="four-oh-four"><h1>404 Ошибка</h1></div>

    <div class="warning">
        <h2>Произошел технический сбой</h2>
        <p>Возможно, страница, которую вы ищете, была удалена, изменилось ее имя или временно недоступно.</p>
        <a href="/">Нажмите чтоб вернутся на главную</a>
    </div>
