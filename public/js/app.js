...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AppCart", function() { return AppCart; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ProductModal__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__CartModal__ = __webpack_require__(72);
...
var AppCart = function (_Component) {
    ...
    function AppCart() {
        ...
        var _this = _possibleConstructorReturn(this, (AppCart.__proto__ || Object.getPrototypeOf(AppCart)).call(this));
        ...
        _this.setCustomEventListener();

        _this.closeProductModal = _this.closeProductModal.bind(_this);
        _this.closeCartModal = _this.closeCartModal.bind(_this);
        _this.openCartModal = _this.openCartModal.bind(_this);
        _this.changeAmountCart = _this.changeAmountCart.bind(_this);
        _this.changeDeleteCart = _this.changeDeleteCart.bind(_this);
        return _this;
    }
    ...
    _createClass(AppCart, [{
        key: 'getClickProduct',
        value: function getClickProduct(id) {
            var _this2 = this;

            this.state.products.data.forEach(function (product) {
                if (product.id === id) {
                    _this2.setState({
        ...
        key: 'setCustomEventListener',
        value: function setCustomEventListener() {
            var _this3 = this;

            document.addEventListener('showProduct', function (event) {
                // получаем id нажатого товара
                var id = +event.target.dataset.idProduct;
                _this3.getClickProduct(id);
            });
        }
        ...
        key: 'addToCart',
        value: function addToCart(productCar) {
            this.setState(function (prevState) {
                return {
                    cartContent: [].concat(_toConsumableArray(prevState.cartContent), [productCar])
                };
            });
        }
        ...
        key: 'changeAmountCart',
        value: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(product, flag) {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _context.next = 3;
                                return __WEBPACK_IMPORTED_MODULE_3_axios___default.a.post('/cart/plus', product);
                            ...
                            case 7:
                                ...
                                _context.next = 10;
                                return __WEBPACK_IMPORTED_MODULE_3_axios___default.a.post('/cart/minus', product);

                            case 10:
                                _response = _context.sent;

                                this.setState({
                                    cartContent: _response.data
                                });
            ...
            function changeAmountCart(_x, _x2) {
                return _ref.apply(this, arguments);
            }

            return changeAmountCart;
        }()
        ...
        key: 'changeDeleteCart',
        value: function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee2(rowId) {
                var response;
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                _context2.next = 2;
                                return __WEBPACK_IMPORTED_MODULE_3_axios___default.a.post('/cart/delete', rowId);
            ...
            function changeDeleteCart(_x3) {
                return _ref2.apply(this, arguments);
            }

            return changeDeleteCart;
        }()
    }, {
        key: 'render',
        value: function render() {
            return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__ProductModal__["a" /* default */], {
                    modalIsOpen: this.state.modalProductIsOpen,
                    closeModal: this.closeProductModal,
                    selectProduct: this.state.selectProduct,
                    addToCart: this.addToCart.bind(this)
                }),
                __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__CartModal__["a" /* default */], {
...
if (document.getElementById('app-cart')) {
    __WEBPACK_IMPORTED_MODULE_2_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(AppCart, null), document.getElementById('app-cart'));
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_modal__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_axios__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ProductAttributes__ = __webpack_require__(71);
...
// Путь до картинок
var pathToImagesProduct = window.location.origin + '/products/images/';
...
var ProductModal = function (_Component) {
    ...
    _createClass(ProductModal, [{
        ...
        value: function selectAttributes(arr) {
            this.setState({
        ...
        key: 'calcPrice',
        value: function calcPrice(arr) {
            var result = this.props.selectProduct.price;
        ...
        key: 'amountClick',
        value: function amountClick(val) {
            if (val) {
                this.setState({
        ...
        key: 'apiCartAdd',
        value: function apiCartAdd(productCar) {
            return __WEBPACK_IMPORTED_MODULE_3_axios___default.a.post('/cart/add', productCar);
        }
        ...
        key: 'showMessage',
        value: function showMessage(status) {
            var _this2 = this;
        ...
        value: function render() {
            ...
            return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                    ...
                    this.state.showMessage ? __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                        'p',
                        { className: ['modal-product-message', this.state.messageSuccess ? 'success' : 'error'].join(' ') },
                        this.state.message
                    ) : '',
                    ...
                    __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                            ...
                            this.props.selectProduct && this.props.selectProduct.name
                        ),
                        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                            'p',
                    ...
                    this.props.selectProduct ? __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__ProductAttributes__["a" /* default */], {
                        attributes: this.props.selectProduct.attributes,
                        onSelectAttributs: this.selectAttributes.bind(this)
                    }) : '',
                    __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                        'div',
                        { className: 'modal-product-control' },
                        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                            'span',
                        ...
                        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                            'div',
                            { className: 'modal-product-amount' },
                            ...
                            __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                                'span',
                                { className: 'modal-product-amount-text' },
                                this.state.amount
                            ),
                            __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement('span', {
                        ...
                        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                            'div',
                            { className: 'modal-product-cart',
                                onClick: this.addProductToCart.bind(this) },
                            '\u0412 \u043A\u043E\u0440\u0438\u0437\u0438\u043D\u0443'
                        )
                    ),
                    __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement('div', { className: 'modal-product-close', onClick: this.closeModal })
                )
            );
        }
    }]);
...
var ProductAttributes = function (_Component) {
    _inherits(ProductAttributes, _Component);

    function ProductAttributes(props) {
        _classCallCheck(this, ProductAttributes);

        // TODO: переделать хранилище на redux
        var _this = _possibleConstructorReturn(this, (ProductAttributes.__proto__ || Object.getPrototypeOf(ProductAttributes)).call(this, props));

        _this.state = {
            // сортируем артирбуты и добовляем новые поля
            attributes: [].concat(_toConsumableArray(_this.props.attributes)).sort(sort).map(function (val) {
                var newAttrVal = val.product_group_attributes.product_group_attributes_value.map(function (valAttr, i) {
                    // устанавливаем у 1 элемента выбор
                    var select = i === 0 ? true : false;
                    return _extends({}, valAttr, { select: select });
                });
    ...
    _createClass(ProductAttributes, [{
        key: 'reselectAttribute',
        value: function reselectAttribute(iVal, iAttrVal) {
            var _this2 = this;

            // находим выбраный атрибут и меняем его свойства
            this.setState({
                attributes: [].concat(_toConsumableArray(this.state.attributes.map(function (val, i) {
                    if (i === iVal) {
                        return _extends({}, val, { product_group_attributes: _extends({}, val.product_group_attributes, {
                                product_group_attributes_value: val.product_group_attributes.product_group_attributes_value.map(function (attrVal, iAtVal) {
                                    return _extends({}, attrVal, { select: iAtVal === iAttrVal ? true : false });
                                })
                            })
                        });
                    }
        ...
        key: 'renderAttribute',
        value: function renderAttribute(val, iVal) {
            var _this3 = this;

            var groupAttributes = val.product_group_attributes;
            var groupAttributesValue = val.product_group_attributes.product_group_attributes_value;

            switch (val.product_group_attributes.type) {
                case 'Размер':
                    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'div',
                        { key: val.id, className: 'product-attributes-container' },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'p',
                            { className: 'product-attributes-container-name' },
                            groupAttributes.type
                        ),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'ul',
                            { className: 'product-attributes-container-ul product-attributes-container-size' },
                            groupAttributesValue.map(function (attrVal, iAttrVal) {
                                return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    'li',
                                    { key: attrVal.id,
                                        onClick: _this3.reselectAttribute.bind(_this3, iVal, iAttrVal),
                                        className: 'product-attributes-container-li' + (attrVal.select ? ' product-attributes-container-li-select' : '') },
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        'span',
                                        {
                ...
                case 'Цвет':
                    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'ul',
                            { className: 'product-attributes-container-ul product-attributes-container-color' },
                            groupAttributesValue.map(function (attrVal, iAttrVal) {
                                return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    'li',
                                    { key: attrVal.id,
                ...
                default:
                    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'ul',
                            { className: 'product-attributes-container-ul' },
                            groupAttributesValue.map(function (attrVal, iAttrVal) {
                                return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    'li',
                                    { key: attrVal.id,
        ...
        value: function selectAttributes() {
            var result = [];

            this.state.attributes.map(function (val) {
                var valAttrObj = null;

                val.product_group_attributes.product_group_attributes_value.map(function (valAttr) {
                    if (valAttr.select) {
                        valAttrObj = valAttr;
                    }
                });
        ...
        value: function render() {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
                { className: 'modal-product-attributes' },
                this.state.attributes.map(function (val, i) {
                    return _this4.renderAttribute(val, i);
                })
            );
        }
    }]);
...
/* harmony default export */ __webpack_exports__["a"] = (ProductAttributes);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_modal__ = __webpack_require__(17);
...
var CartModal = function (_Component) {
    ...
    function CartModal(props) {
        ...
        // TODO: переделать хранилище на redux
        var _this = _possibleConstructorReturn(this, (CartModal.__proto__ || Object.getPrototypeOf(CartModal)).call(this, props));
    ...
    _createClass(CartModal, [{
        ...
        key: 'amountClick',
        value: function amountClick(product, flag) {
            this.props.changeAmountCart(product, flag);
        }
    }, {
        key: 'deleteClick',
        value: function deleteClick(rowId) {
            this.props.changeDeleteCart({ rowId: rowId });
        }
    }, {
        key: 'totalPrice',
        value: function totalPrice() {
            return this.props.cartContent.reduce(function (sum, val) {
        ...
        value: function render() {
            ...
            // позиция картинок в модалке
            var productImgStyle = function productImgStyle(val) {
                var product = val.options.product;
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'div',
                        { className: 'modal-cart-title' },
                        '\u041A\u043E\u0440\u0437\u0438\u043D\u0430'
                    ),
                    this.props.cartContent.map(function (val, i) {
                        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'div',
                            { key: i, className: 'modal-cart-product' },
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', {
                                className: 'modal-cart-product-img',
                                style: productImgStyle(val) }),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                'div',
                                { className: 'modal-cart-product-info' },
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    'div',
                                    { className: 'modal-cart-product-info-name' },
                                    val.name
                                ),
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    'div',
                                    { className: 'modal-cart-product-info-attributes' },
                                    val.options.selectAttributes.map(function (selAttr, i) {
                                        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            'div',
                                            {
                                                key: i,
                                ...
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    'div',
                                    { className: 'modal-cart-product-info-price' },
                                    '1 \u0448\u0442: ',
                                    val.price,
                                    ' \u0420'
                                )
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                'div',
                                { className: 'modal-cart-product-control' },
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    'div',
                                    { className: 'modal-cart-product-subtotal' },
                                    '\u0418\u0442\u043E\u0433\u043E: ',
                                    val.subtotal,
                                    ' \u0440'
                                ),
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    'div',
                                    { className: 'modal-cart-product-amount' },
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span', {
                                        className: 'modal-cart-product-amount-procedure glyphicon-minus',
                                        onClick: _this2.amountClick.bind(_this2, val, false)
                                    }),
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        'span',
                                        { className: 'modal-cart-product-amount-text' },
                                        val.qty
                                    ),
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span', {
                                        className: 'modal-cart-product-amount-procedure glyphicon-plus',
                                        onClick: _this2.amountClick.bind(_this2, val, true)
                                    })
                                ),
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    'div',
                                    {
                                        ...
                                        onClick: _this2.deleteClick.bind(_this2, val.rowId) },
                                    '\u0443\u0434\u0430\u043B\u0438\u0442\u044C'
                                )
                            )
                        );
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'div',
                        { className: 'modal-cart-total' },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'span',
                            { className: 'modal-cart-total-price' },
                            this.totalPrice(),
                            ' \u0420'
                        ),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: 'modal-cart-close', onClick: this.closeModal })
                )
            );
        }
    }]);
...
/* harmony default export */ __webpack_exports__["a"] = (CartModal);
...
var elements = document.getElementsByClassName('product-price-name');
var _iteratorNormalCompletion = true;
var _didIteratorError = false;
var _iteratorError = undefined;
...
try {
    for (var _iterator = elements[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        element.addEventListener('click', function (event) {
            ...
            var newEvent = new Event('showProduct', { bubbles: true, cancelable: true });
